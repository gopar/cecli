...
class TestMain:
    ...
    def test_main_with_dname_and_fname(self, dummy_io, git_temp_dir):
        subdir = Path("subdir")
        subdir.mkdir()
    ...
    def test_main_copy_paste_model_overrides(self, dummy_io, git_temp_dir):
    ...
    def test_main_with_git_config_yml(self, dummy_io, mock_coder, git_temp_dir):
        make_repo()
    ...
    def test_main_with_empty_git_dir_new_subdir_file(self, dummy_io, git_temp_dir):
        make_repo()
        subdir = Path("subdir")
        subdir.mkdir()
    ...
    def test_main_args(self, args, expected_kwargs, dummy_io, mock_coder, git_temp_dir):
        main(args, **dummy_io)
        _, kwargs = mock_coder.call_args
    ...
    def test_read_option_with_external_file(self, dummy_io, git_temp_dir):
    ...
    def test_model_metadata_file(self, dummy_io, git_temp_dir):
    ...
    def test_4o_and_cache_options(self, dummy_io, git_temp_dir):
        coder = main(
    ...
    def test_return_coder(self, dummy_io, git_temp_dir):
        result = main(
            ["--exit", "--yes-always"],
            **dummy_io,
            return_coder=True,
    ...
    def test_map_mul_option(self, dummy_io, git_temp_dir):
        coder = main(
    ...
    def test_boolean_flags(self, flag_arg, attr_name, expected, dummy_io, git_temp_dir):
    ...
    def test_set_env(self, set_env_args, expected_env, expected_result, dummy_io, git_temp_dir):
    ...
    def test_api_key(self, api_key_args, expected_env, expected_result, dummy_io, git_temp_dir):
    ...
    def test_git_config_include(self, dummy_io, git_temp_dir):
    ...
    def test_git_config_include_directive(self, dummy_io, git_temp_dir):
    ...
    def test_resolve_aiderignore_path(self, dummy_io, git_temp_dir):
    ...
    def test_default_model_selection(self, api_key_env, expected_model_substr, dummy_io, git_temp_dir):
    ...
    def test_commit_language_japanese(self, dummy_io, git_temp_dir):
        coder = main(
    ...
    def test_reasoning_effort_option(self, dummy_io, git_temp_dir):
        coder = main(
            [
                "--reasoning-effort",
                "3",
    ...
    def test_thinking_tokens_option(self, dummy_io, git_temp_dir):
        coder = main(
    ...
    def test_argv_file_respects_git(self, dummy_io, git_temp_dir):
